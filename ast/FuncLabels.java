...
public class FuncLabels extends Node {
    ...
    public void findPrincipal(HashSet<String> principalSet) {
        ...
        if (end_pc != null) end_pc.findPrincipal(principalSet);
    }
    ...
    public boolean typeMatch(FuncLabels funcLabels) {
        boolean l1 = begin_pc == null, l2 = to_pc == null, l3 = gamma_label == null, l4 = end_pc == null;
        boolean r1 = funcLabels.begin_pc == null, r2 = funcLabels.to_pc == null, r3 = funcLabels.gamma_label == null, r4 = end_pc == null;
