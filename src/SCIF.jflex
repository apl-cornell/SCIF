...
//        addKeyword("as",      Integer.valueOf(sym.AS));
        ...
        addKeyword("closure", Integer.valueOf(sym.CLOSURE));
        addKeyword("closurable", Integer.valueOf(sym.CLOSURABLE));
        addKeyword("fun", Integer.valueOf(sym.FUN));
        addKeyword("_", Integer.valueOf(sym.HOLE));
...
//        addKeyword("endorseIf", Integer.valueOf(sym.ENDORSEIF));
        ...
        addKeyword("public", Integer.valueOf(sym.PUBLIC));
        addKeyword("payable", Integer.valueOf(sym.PAYABLE));
        addKeyword("protected", Integer.valueOf(sym.PROTECTED));
        addKeyword("private", Integer.valueOf(sym.PRIVATE));
        addKeyword("native", Integer.valueOf(sym.NATIVE));
